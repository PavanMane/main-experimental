...
-- TODO
- check fsType - XFS
- defragmentation currently set to 'always', research on 'never'
- optimize / best practises for mongodb deployment
- mongodb replica sets, 
	and use the same replica uri of format: mongodb://<mongo_instance1>:<port>,<mongo_instance1>:<port>,<mongo_instance1>:<port>/dbName_?
